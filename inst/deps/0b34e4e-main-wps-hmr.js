  ...
  function CislMovingParts() {
    ...
    function handle_mousemove(e_move, e_down) {
      ...
      if (["cisl-handle-to", "cisl-label-to"].some(function (cl) {
        ...
        this.props.setProps({
          angleState: [adjustedState[0], new_angle]
        });
        ...
        this.props.setProps({
          angleState: [new_angle, adjustedState[1]]
        });
        ...
        this.props.setProps({
          angleState: [new_angle - e_down.cisl_slice_from, new_angle + e_down.cisl_slice_to]
        });
      }
    }
    ...
    function handle_keydown(e_press) {
      ...
      */
      ...
      if (scale) {
        ...
        this.props.setProps({
          angleState: [adjustedState[0] + weight / 2, adjustedState[1] - weight / 2]
        });
        ...
        this.props.setProps({
          angleState: [adjustedState[0], adjustedState[1] + weight]
        });
      } else if (["cisl-handle-from", "cisl-label-from"].some(function (cl) {
        return e_press.target.classList.contains(cl);
      })) {
        ...
        this.props.setProps({
          angleState: [adjustedState[0] + weight, adjustedState[1]]
        });
        ...
        this.props.setProps({
          angleState: [adjustedState[0] + weight, adjustedState[1] + weight]
        });
      }
      /*
      if (typeof this.onFinish === "function") {
    ...
    function handle_wheel(e_wheel) {
      ...
      */
      ...
      this.props.setProps({
        angleState: [adjustedState[0] - weight * Math.PI / 50, adjustedState[1] + weight * Math.PI / 50]
...
//# sourceMappingURL=0b34e4e-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIwYjM0ZTRlLW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==
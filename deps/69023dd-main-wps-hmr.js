...
function Cisl(props) {
  ...
  var cislRef = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])(null); // the viewBox is 100x100 units, centered at 50,50

  var radius = 175; // // Respond to resizes
  // useLayoutEffect(() => {
  ...
  function CislMovingParts() {
    ...
    var handle_mousedown = function handle_mousedown(e_down) {
      e_down.persist(); // e_down.preventDefault();
    ...
    function handle_keydown(e_press) {
      ...
      */
      ...
      if (scale) {
        ...
        props.setProps({
          value: [angle2value(adjustedState[0]), angle2value(adjust_angle(adjustedState[1] + weight))]
        });
      } else if (["cisl-handle-from", "cisl-label-from"].some(function (cl) {
        return e_press.target.classList.contains(cl);
      })) {
...
//# sourceMappingURL=69023dd-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiI2OTAyM2RkLW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==
...
#' @export
dashDashCisl <- function(id=NULL, breaks_altitude=NULL, breaks_n=NULL, digits=NULL, labels_altitude=NULL, major_breaks_every=NULL, max=NULL, min=NULL, postfix=NULL, prefix=NULL, rails_border_width=NULL, rails_width=NULL, step=NULL, value=NULL, values_sep=NULL) {
